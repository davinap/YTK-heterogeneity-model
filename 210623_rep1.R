...
setwd("C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/210623/210623_csv_Rep1/")
#Load packages
library(tidyverse)
library(gtools)
library(reshape2)
...
y1_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/210623/210623_csv_Rep1/210623_r1_ypd_exp/", 
                              full.names=TRUE))
...
write.xlsx(y1_fd,'y1_fd_210623_r1.xlsx') #save
...
y2_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/210623/210623_csv_Rep1/210623_r1_ypd_sta/", 
                              full.names=TRUE))
...
write.xlsx(y2_fd,'y2_fd_210623_r1.xlsx')
...
####===================================================MEDIA 3 - X1=======================================================####
#read in files in A1, A2... order and test
x1_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/210623/210623_csv_Rep1/210623_r1_ypdx_exp/", 
                              full.names=TRUE))
...
write.xlsx(x1_fd,'x1_fd_210623_r1.xlsx')
...
####===================================================MEDIA 4 - X2=======================================================####
#read in files in A1, A2... order and test
x2_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/210623/210623_csv_Rep1/210623_r1_ypdx_sta/", 
                              full.names=TRUE))
...
write.xlsx(x2_fd,'x2_fd_210623_r2.xlsx')
...
#read in files in A1, A2... order and test
m1_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/210623/210623_csv_Rep1/210623_r1_ynb_exp/", 
                              full.names=TRUE))
...
write.xlsx(m1_fd,'m1_fd_210623_r1.xlsx')
...
#read in files in A1, A2... order and test
m2_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/210623/210623_csv_Rep1/210623_r1_ynb_sta/", 
                              full.names=TRUE))
...
write.xlsx(m2_fd,'m2_fd_210623_r1.xlsx')
...
#read in files in A1, A2... order and test
g1_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/210623/210623_csv_Rep1/210623_r1_yepg_exp/", 
                              full.names=TRUE))
...
write.xlsx(g1_fd,'g1_fd_210623_r1.xlsx')
...
#read in files in A1, A2... order and test
g2_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/210623/210623_csv_Rep1/210623_r1_yepg_sta/", 
                              full.names=TRUE))
...
write.xlsx(g2_fd,'g2_fd_210623_r1.xlsx')
