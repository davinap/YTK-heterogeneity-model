...
setwd("C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/140623/140623_csv_Rep2/")
#Load packages
library(tidyverse)
library(gtools)
library(reshape2)
...
y1_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/140623/140623_csv_Rep2/140623_r2_ypd_exp/", 
                              full.names=TRUE))
...
write.xlsx(y1_fd,'y1_fd_140623_r2.xlsx') #save
...
y2_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/140623/140623_csv_Rep2/140623_r2_ypd_sta/", 
                              full.names=TRUE))
...
write.xlsx(y2_fd,'y2_fd_140623_r2.xlsx')
...
####===================================================MEDIA 3 - X1=======================================================####
#read in files in A1, A2... order and test
x1_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/140623/140623_csv_Rep2/140623_r2_ypdx_exp/", 
                              full.names=TRUE))
...
write.xlsx(x1_fd,'x1_fd_140623_r2.xlsx')
...
#extract control sample
#CHANGE 'B8' DEPENDING ON WELL OF CONTROL SAMPLE
ctrl <- filter(melt_x1, grepl("B8",variable))
...
####===================================================MEDIA 4 - X2=======================================================####
#read in files in A1, A2... order and test
x2_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/140623/140623_csv_Rep2/140623_r2_ypdx_sta/", 
                              full.names=TRUE))
...
#read in files in A1, A2... order and test
m1_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/140623/140623_csv_Rep2/140623_r2_ynb_exp/", 
                              full.names=TRUE))
...
write.xlsx(m1_fd,'m1_fd_140623_r2.xlsx')
...
#extract control sample
#CHANGE 'B8' DEPENDING ON WELL OF CONTROL SAMPLE
ctrl <- filter(melt_m1, grepl("D8",variable))
...
#read in files in A1, A2... order and test
m2_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/140623/140623_csv_Rep2/140623_r2_ynb_sta/", 
                              full.names=TRUE))
...
write.xlsx(m2_fd,'m2_fd_140623_r2.xlsx')
...
#read in files in A1, A2... order and test
g1_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/140623/140623_csv_Rep2/140623_r2_yepg_exp/", 
                              full.names=TRUE))
...
write.xlsx(g1_fd,'g1_fd_140623_r2.xlsx')
...
#read in files in A1, A2... order and test
g2_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/KS_analyses/140623/140623_csv_Rep2/140623_r2_yepg_sta/", 
                              full.names=TRUE))
...
write.xlsx(g2_fd,'g2_fd_140623_r2.xlsx')
